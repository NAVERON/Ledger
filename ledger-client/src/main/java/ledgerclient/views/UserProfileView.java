...
public class UserProfileView extends FlowPane {
    ...
    private final BooleanProperty isLogin = new SimpleBooleanProperty();  // 表明当前是否已经登录
    ...
    private void initComponent() {
        ...
        this.userICON.setClip(new Circle(50, 50, 50));
        ...
        ImageView loginICON = new ImageView(
                Objects.requireNonNull(getClass().getResource("/assets/images/drink.png")).toExternalForm()
        );
        ...
        this.userICON.setOnMouseClicked(event -> {
            ...
            if (this.isLogin.getValue()) {
                ...
                Alert alert = new Alert(
                        AlertType.CONFIRMATION, "Logout ?", ButtonType.YES, ButtonType.CANCEL
                );
                alert.showAndWait();
